/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: eed2412643b78dec72b6db6acadbaeb5)
...
interface __BaseEnv_Env {
	...
	LOGIN_STRATEGY: "auto";
	PUBLIC_BASE_URL: "";
	SESSION: DurableObjectNamespace<import("./src/index").WeWorkSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WeWorkSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WRITE_ENABLED" | "MAX_BOOKINGS_PER_DAY" | "MAX_BOOKINGS_PER_WEEK" | "MAX_CREDITS_PER_BOOKING" | "LOGIN_STRATEGY" | "PUBLIC_BASE_URL">> {}
}
